...
function Home() {
  ...
  const fetchBookingRequests = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${BOOKING_API_URL}?email=${encodeURIComponent(userEmail)}`,
        {
          headers: {
  ...
  const uploadPaymentSlip = (bookingId, file) => {
    ...
    if (file.size > 5 * 1024 * 1024)
      return alert("Slip image must be smaller than 5MB.");
    const reader = new FileReader();
    setSlipUploadingId(bookingId);
    reader.onload = async () => {
      try {
        const response = await fetch(
          `${BOOKING_API_URL}/${bookingId}/payment-slip`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
        ...
        alert(error.message || "Unable to upload the payment slip.");
      } finally {
        setSlipUploadingId("");
      }
    };
  ...
  return (
    <div>
                    ...
                    >
                      ...
                      <div className="booking-info">
                        <div className="booking-header">
                          ...
                          <span
                            className={`booking-status ${booking.status?.toLowerCase() || "pending"}`}
                          >
                        ...
                        <div className="booking-details">
                          ...
                          <br />
                          <small>
                            Duration: {booking.duration || "N/A"} • Price: LKR {Number(booking.estimatedPrice || 0).toLocaleString()}
                          </small>
                          <br />
                        ...
                        {(booking.status === "Price Sent" || booking.status?.toLowerCase() === "confirmed") && (
                          <div className="payment-card">
                            <strong>Payment Details</strong>
                            {booking.paymentAccount?.bankName ||
                            booking.paymentAccount?.accountNumber ? (
                              <div className="payment-account-details">
                                <span>
                                  Bank: {booking.paymentAccount.bankName || "—"}
                                </span>
                                <span>
                                  Account name:{" "}
                                  {booking.paymentAccount.accountName || "—"}
                                </span>
                                <span>
                                  Account number:{" "}
                                  {booking.paymentAccount.accountNumber || "—"}
                                </span>
                                {booking.paymentAccount.instructions && (
                                  <span>
                                    {booking.paymentAccount.instructions}
                                  </span>
                                )}
                            ...
                            {booking.paymentSlip?.data ? (
                              <div className="slip-uploaded">
                                ...
                                {booking.paymentSlip.fileName}
                              </div>
                            ) : (
                              <label className="slip-upload-btn">
                                {slipUploadingId === booking._id
                                  ? "Uploading slip..."
                                  : "Upload payment slip"}
                                <input
                                  type="file"
                                  accept="image/*"
                                  disabled={slipUploadingId === booking._id}
                                  onChange={(e) =>
                                    uploadPaymentSlip(
                                      booking._id,
                                      e.target.files[0],
      ...
      <div className="home reveal-section" id="home" ref={homeRef}>
        ...
        <div className="home-content">
          <div className="home-text">
            ...
            <p className="line3">
              Photography, videography, live broadcast, design and words —
              J'pura Flames turns campus matches, ceremonies and late
            ...
            <div className="hero-actions">
              ...
              <a href="" className="bookingBtn" onClick={handleBookingClick}>
                Booking
              </a>
            </div>
          </div>
      ...
      {/* Services Section */}
      <section
        className="home-services reveal-section"
        ...
        <div className="about-new">
          <div className="about-overview">
            <div className="about-intro">
              ...
              <p>
                J'pura Flames is the official student-run media unit of the
                University of Sri Jayewardenepura, capturing campus stories
                through photography, videography, design, broadcasting, and
                journalism.
              </p>
            </div>
          ...
          <div className="services-grid">
            <article>
              ...
              <h4>Photography</h4>
              <p>
                Match-day action, portraits and campus life, frame by frame.
              </p>
            </article>
            <article>
              <i>🎥</i>
              <h4>Videography</h4>
              <p>Highlight reels, event recaps and the moments between.</p>
            </article>
            <article>
              <i>🎨</i>
              <h4>Graphic Design</h4>
              <p>
                Posters, social creatives and visual identity for every event.
              </p>
            </article>
            <article>
              <i>🎙️</i>
              <h4>Broadcasting</h4>
              <p>
                Real-time commentary and coverage from the biggest fixtures.
              </p>
            </article>
            <article>
              <i>✍️</i>
              <h4>Article & Poetry</h4>
              <p>
                Creative writing that captures the feeling behind the moment.
              </p>
            </article>
            <article>
              <i>🖥️</i>
              <h4>IT & Marketing</h4>
              <p>
                Digital experiences that power creativity and collaboration.
              </p>
            </article>
            <article>
              <i>👨‍💼</i>
              <h4>HR</h4>
              <p>Building a connected, motivated team that grows together.</p>
            </article>
      ...
      <section
        ...
        ref={projectsRef}
      >
        <div className="project-simg">
          <img src="/image/pr-st.jpg" alt="pr" />
        </div>
              ...
              {projects.map((project) => (
                <div className="project-card" key={project._id}>
                  <div className="project-image">
                    <img
                      src={project.image || "/img/wait.jpeg"}
                      alt={project.title}
                      onError={(e) => {
                        e.target.src = "/img/wait.jpeg";
                      }}
                    />
                    <div
                      className={`project-status ${project.status === "Completed" ? "status-completed" : project.status === "In Progress" ? "status-progress" : "status-planning"}`}
                    >
                  ...
                  <div className="project-info">
                    ...
                    <div className="project-tech">
                      <span className="tech-stack">
                        📅 {project.eventDate || "Date TBD"}
                      </span>
                      <span className="tech-stack">
                        📍 {project.eventLocation || "Location TBD"}
                      </span>
                    </div>
      ...
      <section className="gallary reveal-section" id="gallary" ref={galleryRef}>
        <div className="gallery-header">
          ...
          <p>
            Discover our best moments from campus events, ceremonies, and
            creative stories.
          </p>
        </div>
      ...
      <section id="contact">
        <div className="contact-info-item">
          ...
          <div className="details">
            ...
            <a href="mailto:info@jpuraflames.lk" className="value">
              info@jpuraflames.lk
            </a>
          </div>
        </div>
        <div className="contact-info-item">
          ...
          <div className="details">
            ...
            <a href="tel:+94771234567" className="value">
              +94 77 123 4567
            </a>
          </div>
        </div>
        ...
        <div className="social-icons">
          <a
            href="https://www.youtube.com/@JpuraFlames"
          ...
          <a
            href="https://www.facebook.com/Jpuraflames"
          ...
          <a
            href="https://www.instagram.com/jpuraflames"
          ...
          <a
            href="https://www.tiktok.com/@jpuraflames"
      ...
      <footer className="site-footer">
        ...
        <p className="footer-copy">
          © 2026 J'Pura Flames. All rights reserved.
        </p>
      </footer>
    </div>
  );
